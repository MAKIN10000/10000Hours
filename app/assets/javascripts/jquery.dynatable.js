...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      paginationLinkClass: 'none',
      paginationPrevClass: 'none',
      paginationNextClass: 'none',
  ...
  function InputsSearch(obj, settings) {
    ...
    this.create = function() {
      var $search = $('<input />', {
          ...
          $searchSpan = $('<form></form>', {
            id: 'dynatable-search-' + obj.element.id,
            'class': 'form-inline pull-right',
            html: '<label for="dynatable-query-search-'+obj.element.id+'">Search: </label>'
          }).append($search);
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      ...
      }).append("<label for='dynatable-per-page-"+obj.element.id+"'>" + settings.inputs.perPageText + "</label>").append($select);
    };
